...
Original file is located at
    https://colab.research.google.com/drive/1sBDtmY6iOVhwq3EkIND5uFRGG7OlQToP
...
def sse(X, y, theta):
  ...
  # return y.T @ y - (y.T @ predict(X, theta))
  # return y.T @ y - (theta.T @ X.T @ y)
